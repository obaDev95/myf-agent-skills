...
<template>
  <div class="space-y-4">
    <div class="mds-table-and-caption">
      ...
      >
        <table>
          <caption :id="tableLabelId" class="mds-table-caption mds-table-caption--small">
          ...
          <thead>
            <tr>
              ...
              <th scope="col" class="mds-table__cell--number" :aria-sort="sortDirection">
                <button type="button" @click="toggleCapacitySort">Capacity (TEU)</button>
              </th>
            </tr>
          </thead>
          <tbody>
